...
public class BlueLeftSixPiece extends FastAutoBase{
    double[][] point0 = {FieldLayout.blueShootingLeft};
    double[][] noteOne = {KurtMath.addXYToPoint(FieldLayout.blueFirstNote, 16, -35),FieldLayout.blueFirstNote};
    double[][] noteTwo = {KurtMath.addXYToPoint(FieldLayout.blueSecondNote, -20, -24),FieldLayout.blueSecondNote};
    double[][] noteThree = {KurtMath.addXYToPoint(FieldLayout.blueThirdNote, -26, -24),KurtMath.addXYToPoint(FieldLayout.blueThirdNote, -10, -10)};
    double[][] noteFourTo = {KurtMath.convertToVelocity(KurtMath.addXYToPoint(FieldLayout.blueStageLeft, 0, -38),2,14)
        , KurtMath.convertToVelocity(FieldLayout.blueStageLeft,2,14)
        , KurtMath.convertToVelocity(KurtMath.addXYToPoint(FieldLayout.blueThirdNoteLong, 0, -35),2,14), FieldLayout.blueThirdNoteLong};
    double[][] LongNoteBack = {KurtMath.convertToVelocity(KurtMath.addXYToPoint(FieldLayout.blueThirdNoteLong, 0, -120),2,14), FieldLayout.blueStageLeft};
    double[][] noteFiveTo = {KurtMath.convertToVelocity(KurtMath.addXYToPoint(FieldLayout.blueFourthNoteLong, 0, -35),2,14), FieldLayout.blueFourthNoteLong};
