...
public class BlueRightThreePieceSuperLong extends FastAutoBase{
    ...
    double[][] point1 = {{-2.85,80.67,0,3.5}, {-5.58,40.21,314.69,3}};
    double[][] firstNote = {{100.25, 164.75,0,16,5},{113, 188,0,16,4},{133.95,300.89,0,3}};
    double[][] secondNote = {{90.25, 164.75,0,16,5},{90, 188,0,16,4},{67.95,300.89,0,3}};
    double[][] point3 = {{95.94,170.56,0,16,5}, {20.53,50.80,314.69,16,3.5},{-5.58,40.21,314.69,3}};
    ...
    public void routine() throws Exception {
        ...
        runCommand(new FastParallel(List.of(
            ...
            new FastSeries(List.of(
                new PassXYCommand(-5.58,40.21, 3),
